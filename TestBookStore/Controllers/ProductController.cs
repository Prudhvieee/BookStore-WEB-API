    ...
    public class ProductController : ControllerBase
    {
        ...
        public IActionResult GetAllProducts()
        {
            try
            {
                ...
                if (empList != null)
                {
                    return this.Ok(new { success = true, Message = "get Products successfully", data = empList });
                }
                else
                {
                    return this.NotFound(new { success = false, Message = "get Products unsuccessfully" });
                }
            }
            catch (Exception e)
            {
